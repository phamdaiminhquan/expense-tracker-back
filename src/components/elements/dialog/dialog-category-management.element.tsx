...
interface DialogCategoryManagementProps {
  open: boolean;
...
export function DialogCategoryManagement({
  open,
  onOpenChange,
  categories,
  messages,
                ...
                {isCreating ? (
                  <React.Fragment>
                    <Button
                      ...
                      className="gap-2 flex-1 shadow-md hover:shadow-lg transition-all"
                    >
                      <Check weight="bold" />
                      Tạo
                    </Button>
            ...
            <div className="space-y-3 pr-4">
              {categories.length === 0 ? (
                ...
                categories.map((category) => {
                  const usageCount = messages.filter(
                  ...
                  return (
                    <Card
                      key={category.id}
                      className={`p-4 border-border/50 shadow-sm hover:shadow-md transition-all ${
                        isBeingEdited ? "opacity-50" : "hover:border-primary/30"
                      }`}
                    >
                      <div className="flex items-start justify-between gap-3">
                        ...
                        <div className="flex gap-2 shrink-0">
                          ...
                          <Button
                            ...
                            disabled={
                              isCreating || editingId !== null || usageCount > 0
                            }
