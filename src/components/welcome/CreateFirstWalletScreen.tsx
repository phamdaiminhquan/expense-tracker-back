...
interface CreateFirstWalletScreenProps {
  userName?: string;
  walletData?: any;
...
export const CreateFirstWalletScreen: React.FC<CreateFirstWalletScreenProps> = ({
  userName,
  walletData,
  onWalletMutate,
  onComplete,
        ...
        <div className="flex flex-col items-center animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            >
              <span className="relative z-10 flex items-center gap-2">
                Tạo ví đầu tiên <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform"/>
              </span>
