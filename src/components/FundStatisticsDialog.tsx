import { Fund, Category } from '@/lib/types'
import {
  Dialog,
  DialogContent,
  DialogHeader,
      ...
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <Card className={`p-5 space-y-3 border-primary/30 ${balance >= 0 ? 'bg-linear-to-br from-primary/10 to-primary/5' : 'bg-linear-to-br from-destructive/10 to-destructive/5'} backdrop-blur-sm shadow-md hover:shadow-lg transition-all overflow-hidden relative`}>
              ...
              <p
                className={`text-2xl font-bold font-mono relative z-10 ${balance >= 0 ? 'text-primary' : 'text-destructive'
                  }`}
              >
