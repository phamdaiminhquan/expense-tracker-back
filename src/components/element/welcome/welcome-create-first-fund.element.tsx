...
interface CreateFirstFundScreenProps {
...
export const CreateFirstFundScreen: React.FC<CreateFirstFundScreenProps> = ({
  onCreateFund,
  currentUserId,
  allUsers,
  onComplete,
        ...
        <div className="flex flex-col items-center animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            >
              <span className="relative z-10 flex items-center gap-2">
                Tạo quỹ chi tiêu <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform"/>
              </span>
